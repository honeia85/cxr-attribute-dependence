-- MIMIC-IV v3.1 Data Load (from .csv.gz)
-- Before running, set MIMIC4_HOSP_DIR in your shell to the directory
-- containing the *.csv.gz files (e.g., /path/to/mimic-iv/hosp), then invoke:
--   psql -v hosp_dir=$MIMIC4_HOSP_DIR -f load_mimic4.sql
-- (or replace :hosp_dir with the literal path).
